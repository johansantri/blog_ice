        ...
        function update_counter($slug_title)
        {
            ...
            $this->db->update('tb_blog');   
             ...
             public function getComment()
                {
                  $this->db->select('tb_comment.id_comment,tb_comment.nama_comment,tb_comment.email_comment,tb_comment.description_comment,tb_comment.status_comment,tb_comment.created_comment, tb_blog.title');
