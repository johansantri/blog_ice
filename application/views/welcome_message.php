...
<div id="loading-icon-bx"></div>
        ...
        <div id="rev_slider_486_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.3.0.2">
          <ul>  <!-- SLIDE  -->
            ...
            data-description="Science says that Women are generally happier">
              <!-- MAIN IMAGE -->
              <img src="<?php echo base_url()?>assets/frontand/images/slider/slide1.jpg" alt="" 
            ...
            data-easeout="default" 
            data-masterspeed="default" 
            data-thumb="<?php echo base_url()?>assets/frontand/images/slider/slide1.jpg" 
            data-rotate="0" 
            data-fstransition="fade" 
            data-fsmasterspeed="1500" 
            data-fsslotamount="7" 
            ...
            data-description="Science says that Women are generally happier">
              <!-- MAIN IMAGE -->
              <img src="<?php echo base_url()?>assets/frontand/images/slider/slide2.jpg" alt="" 
                data-bgposition="center center" 
                data-bgfit="cover" 
                data-bgrepeat="no-repeat" 
                data-bgparallax="10" 
  ...
  <!-- Footer ==== -->
    <footer>
        <div class="footer-top section-area section-sp2 bg-fix ovbl-dark" style="background-image:url(http://localhost/blog_ice/assets/frontand/images/background/ICE.png);">
      <div class="pt-exebar">
        <div class="container">
          ...
          <div class="col-12 col-lg-3 col-md-5 col-sm-12 footer-col-4">
                ...
                <li><a href="<?php echo base_url()?>assets/frontand/images/gallery/pic3.jpg" class="magnific-anchor"><img src="<?php echo base_url()?>assets/frontand/images/gallery/pic3.jpg" alt=""></a></li>
                <li><a href="<?php echo base_url()?>assets/frontand/images/gallery/pic4.jpg" class="magnific-anchor"><img src="<?php echo base_url()?>assets/frontand/images/gallery/pic4.jpg" alt=""></a></li>
                <li><a href="<?php echo base_url()?>assets/frontand/images/gallery/pic5.jpg" class="magnific-anchor"><img src="<?php echo base_url()?>assets/frontand/images/gallery/pic5.jpg" alt=""></a></li>
                <li><a href="<?php echo base_url()?>assets/frontand/images/gallery/pic6.jpg" class="magnific-anchor"><img src="<?php echo base_url()?>assets/frontand/images/gallery/pic6.jpg" alt=""></a></li>
                <li><a href="<?php echo base_url()?>assets/frontand/images/gallery/pic7.jpg" class="magnific-anchor"><img src="<?php echo base_url()?>assets/frontand/images/gallery/pic7.jpg" alt=""></a></li>
                <li><a href="<?php echo base_url()?>assets/frontand/images/gallery/pic8.jpg" class="magnific-anchor"><img src="<?php echo base_url()?>assets/frontand/images/gallery/pic8.jpg" alt=""></a></li>
              </ul>
                        </div>
                    </div>
                </div>
