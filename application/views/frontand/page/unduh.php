            ...
            <div class="col-lg-8">
              ...
              <div class="blog-post blog-md clearfix">
                <div class="ttr-post-media"> 
                  <a href="<?php echo base_url()?>unduh/<?php echo $key->slug_title;?>"><img src="<?php echo base_url()?>upload/<?php echo $key->image; ?>" alt=""></a> 
                </div>
                <div class="ttr-post-info">
                  <ul class="media-post">
                    <li><a href="<?php echo base_url()?>unduh/<?php echo $key->slug_title;?>"><i class="fa fa-calendar"></i><?php echo $key->create_ad;?></a></li>
                    <li><a href="#"><i class="fa fa-user"></i>By ICE-I</a></li>
                  </ul>
                  <h5 class="post-title"><a href="<?php echo base_url()?>unduh/<?php echo $key->slug_title;?>"><?php echo $key->title;?>.</a></h5>
                  <p><?php echo $key->meta;?></p>
                  <div class="post-extra">
                    <a href="<?php echo base_url()?>unduh/<?php echo $key->slug_title;?>" class="btn-link">Baca Selengkapnya</a>
