    ...
    <div class="pt-12 lg:pt-16">
        ...
        <?php foreach ($slide as $key ) {?>
            <div class="hero-slide h-40 lg:h-[65vh] rounded-[17px] lg:rounded-[25px] bg-cover mx-4 w-[70%]" style="background-image: url('<?php echo base_url()?>upload/slide/<?php echo $key->image;?>') "></div>
            <?php };?>    
         </div>
