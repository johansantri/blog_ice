    ...
    <div class="pt-12 lg:pt-16">
        ...
        <?php foreach ($slide as $key ) {?>
            <div class="hero-slide h-40 lg:h-[65vh] rounded-[17px] lg:rounded-[25px] bg-cover mx-4 w-[75%]" style=" background-image: url('upload/slide/<?php echo $key->image;?>') "></div>
            <?php };?>    
         </div>
...
<div class="w-full lg:w-5/6">
    ...
    <?php foreach ($berita as $key ) {?>
            <div>
                ...
                <div class="-mt-7">
                    <img style="width:100%; height:200px; border-radius: 5%;" src="<?php echo base_url()?>upload/<?php echo $key->image;?>" alt="<?php echo $key->title;?>">
                </div>
