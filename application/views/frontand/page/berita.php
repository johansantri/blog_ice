                    ...
                    <div class="grid gap-3 grid-cols-1 lg:grid-cols-3">
                        ...
                        <?php for ($i = 0; $i < 6; $i++) { ?>
                          <div>
                            ...
                            <div class="-mt-7">
                                <img class="w-full h-48 rounded-[20px] object-cover object-center" src="./assets/new/images/<?= $news_obj['image'] ?>" alt="">
                            </div>
                            ...
                            <?php for ($i = 0; $i < 4; $i++) { ?>
                                <div class="flex gap-x-4 mb-7">
                                    <div class="w-5/12 relative">
                                        <img class="rounded-lg w-full h-16 object-center object-cover" src="./assets/new/images/image-gray-college.png" alt="">
                            ...
                            <div class="flex flex-col-reverse lg:flex-row rounded-[2rem]" style="box-shadow: 0px, 4px, 4px rgba(0, 0, 0, .25)">
                                ...
                                <div class="w-full lg:w-fit flex flex-col-reverse lg:flex-row bg-red-primary rounded-tr-[2rem] rounded-tl-[2rem] lg:rounded-tl-none lg:rounded-br-[2rem]">
                                    ...
                                    <div class="w-full lg:w-4/12 flex items-center justify-end">
                                        <img src="./assets/new/images/gray-college-100.png" class="rounded-[2rem] object-cover object-center" style="width: 100%; height: 100%;" alt="">
                                    </div>
                                </div>
                            </div>
