...
<body class="overflow-x-hidden" id="main">
   ...
   <nav class="w-full fixed bg-white z-20 shadow">
        <div class="flex container mx-auto px-5 lg:px-5 py-1 justify-center lg:justify-between">
            <div class="logo flex-initial w-full lg:w-1/4 flex justify-center lg:justify-start items-center ">
               <a href="<?php echo base_url()?>"> <img src="<?php echo base_url()?>assets/new/images/LOGOICE.png" style="width: 200px; " class="w-12 lg:w-16" alt="logo ice institute"></a>
                <!--<h4 class="text-red-600 text-sm font-medium ml-2">ABCDEFG</h4>-->
            </div>
            <ul id="navbar-mobile" class="flex-initial nav-hidden w-full lg:w-3/4 fixed lg:relative bg-white left-0 top-14 lg:top-0 shadow-md lg:shadow-none lg:flex justify-between items-center nav-links py-4 lg:py-0">
                <li>
                ...
                <li>
                    <div class="dropdown inline-block relative w-full">
                        ...
                        <li class=""><a class="rounded-t bg-white hover:bg-gray-200 py-2 font-darker-grotesque text-lg px-4 block whitespace-no-wrap" href="https://kurasi.icei.ac.id" target="_blank">Kurasi</a></li>
                ...
                <li>
                    <a href="https://icei.ac.id/courses" class="px-4 py-2 w-full block lg:py-0 lg:px-0 font-darker-grotesque text-lg text-black">Matakuliah</a>
                </li>
                <li>
                    <div class="dropdown inline-block relative w-full">
                        <button class=" rounded inline-flex items-center w-full px-4 py-2 w-full lg:py-0 lg:px-0 text-left flex justify-start items-center gap-x-1">
                ...
                <li>
                    <div class="px-4 py-2 w-full block lg:py-0 lg:px-0">
                    <form action="<?php echo base_url()?>cari" method="get">
                    <input type="search" id="keyword" style="box-shadow: inset 0px 2px 2px rgba(213, 213, 227, .227); border-radius: 0.35rem; padding: 0px 5px;" name="keyword" placeholder="">
<button type="submit" class="mt-2 rounded-xl bg-red-primary text-white font-bold px-2 py-2"  style="padding: 3px 8px;font-size: 15px;box-shadow: 0px 2px 2px rgba(0, 0, 0, .25); ">Search</button>
</form>
